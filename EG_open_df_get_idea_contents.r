###
### aka 'demystifying R' from the udacity course
###
...
#YK - 1st line creates var numbers = vector of values 1-10
#YK - 2nd line displays vector just created
#YK - 3rd line adds values 11-20 to numbers vector so now goes 1-20
#YK - 4th line displays new full vector of values 1-20

# 2. Replace YOUR_NAME with your actual name in the vector
# 'udacious' and run the code. Be sure to use quotes around it.

#YK - added code as note to illustrate

#udacious <- c("Chris Saden", "Lauren Castellano",
#              "Sarah Spikes","Dean Eckles",
#              "Andy Brown", "Moira Burke",
#              "Kunal Chawla", "Richard Smoker")
...
#YK - nchar command creates values for #characters in each value
# in named vector (udacious) 
# ie when called to display, value1=11 b/c 11char in "Chris Saden"
...
#YK - displays T/F for each value in vector var mystery
#YK - see 3 b/c there are 3 names w 11 char in name
...
#YK - it subsets mystery vector to now only contain values w 11char
